...
return array(
    ...
    'Cltt\\AddComment' => $baseDir . '/src/command/AddComment.php',
    'Cltt\\AddTime' => $baseDir . '/src/command/AddTime.php',
    'Cltt\\ArchiveProject' => $baseDir . '/src/command/ArchiveProject.php',
    'Cltt\\CalculateTime' => $baseDir . '/src/controller/CalculateTime.php',
    'Cltt\\Command' => $baseDir . '/src/command/Command.php',
    'Cltt\\DatabaseAdapter' => $baseDir . '/src/database/DatabaseAdapter.php',
    'Cltt\\DaysOfWeek' => $baseDir . '/src/controller/DaysOfWeek.php',
    'Cltt\\DeleteTime' => $baseDir . '/src/command/DeleteTime.php',
    'Cltt\\EditTime' => $baseDir . '/src/command/EditTime.php',
    'Cltt\\ExportEntries' => $baseDir . '/src/command/ExportEntries.php',
    'Cltt\\FormatTime' => $baseDir . '/src/controller/FormatTime.php',
    'Cltt\\NewProject' => $baseDir . '/src/command/NewProject.php',
    'Cltt\\OutputMessage' => $baseDir . '/src/controller/OutputMessage.php',
    'Cltt\\RestoreProject' => $baseDir . '/src/command/RestoreProject.php',
    'Cltt\\RunningTimers' => $baseDir . '/src/command/RunningTimers.php',
    'Cltt\\Session' => $baseDir . '/src/controller/Session.php',
    'Cltt\\ShowDates' => $baseDir . '/src/command/ShowDates.php',
    'Cltt\\ShowDay' => $baseDir . '/src/command/ShowDay.php',
    'Cltt\\ShowProjects' => $baseDir . '/src/command/ShowProjects.php',
    'Cltt\\ShowTimes' => $baseDir . '/src/command/ShowTimes.php',
    'Cltt\\ShowWeek' => $baseDir . '/src/command/ShowWeek.php',
    'Cltt\\StartProject' => $baseDir . '/src/command/StartProject.php',
    'Cltt\\StopProject' => $baseDir . '/src/command/StopProject.php',
