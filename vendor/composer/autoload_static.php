...
class ComposerStaticInit0d141d32e9162f5c7415075a374fd261
{
    ...
    public static $classMap = array (
        ...
        'Cltt\\AddComment' => __DIR__ . '/../..' . '/src/command/AddComment.php',
        'Cltt\\AddTime' => __DIR__ . '/../..' . '/src/command/AddTime.php',
        'Cltt\\ArchiveProject' => __DIR__ . '/../..' . '/src/command/ArchiveProject.php',
        'Cltt\\CalculateTime' => __DIR__ . '/../..' . '/src/controller/CalculateTime.php',
        'Cltt\\Command' => __DIR__ . '/../..' . '/src/command/Command.php',
        'Cltt\\DatabaseAdapter' => __DIR__ . '/../..' . '/src/database/DatabaseAdapter.php',
        'Cltt\\DaysOfWeek' => __DIR__ . '/../..' . '/src/controller/DaysOfWeek.php',
        'Cltt\\DeleteTime' => __DIR__ . '/../..' . '/src/command/DeleteTime.php',
        'Cltt\\EditTime' => __DIR__ . '/../..' . '/src/command/EditTime.php',
        'Cltt\\ExportEntries' => __DIR__ . '/../..' . '/src/command/ExportEntries.php',
        'Cltt\\FormatTime' => __DIR__ . '/../..' . '/src/controller/FormatTime.php',
        'Cltt\\NewProject' => __DIR__ . '/../..' . '/src/command/NewProject.php',
        'Cltt\\OutputMessage' => __DIR__ . '/../..' . '/src/controller/OutputMessage.php',
        'Cltt\\RestoreProject' => __DIR__ . '/../..' . '/src/command/RestoreProject.php',
        'Cltt\\RunningTimers' => __DIR__ . '/../..' . '/src/command/RunningTimers.php',
        'Cltt\\Session' => __DIR__ . '/../..' . '/src/controller/Session.php',
        'Cltt\\ShowDates' => __DIR__ . '/../..' . '/src/command/ShowDates.php',
        'Cltt\\ShowDay' => __DIR__ . '/../..' . '/src/command/ShowDay.php',
        'Cltt\\ShowProjects' => __DIR__ . '/../..' . '/src/command/ShowProjects.php',
        'Cltt\\ShowTimes' => __DIR__ . '/../..' . '/src/command/ShowTimes.php',
        'Cltt\\ShowWeek' => __DIR__ . '/../..' . '/src/command/ShowWeek.php',
        'Cltt\\StartProject' => __DIR__ . '/../..' . '/src/command/StartProject.php',
        'Cltt\\StopProject' => __DIR__ . '/../..' . '/src/command/StopProject.php',
